...
public:
    ...
    bool setSampleTag ( string sample_id , string tag , string value = "" , string note = "" ) { return setTableTag ( "sample2tag" , sample_id , tag , value , note ) ; }
    bool setFileTag ( string file_id , string tag , string value = "" , string note = "" ) { return setTableTag ( "file2tag" , file_id , tag , value , note ) ; }
    bool setSampleTag ( db_id sample_id , string tag , string value = "" , string note = "" ) { return setSampleTag(i2s(sample_id),tag,value,note) ; }
    bool setFileTag ( db_id file_id , string tag , string value = "" , string note = "" ) { return setFileTag(i2s(file_id),tag,value,note) ; }
    ...
    bool setSampleFile ( db_id sample_id , db_id file_id , string note = "" ) ;
...
private:
    ...
    bool setTableTag ( string table , string id , string tag , string value , string note = "" ) ;
    db_id doGetFileID ( string full_path , string filename , db_id storage = 1 , bool create_if_missing = false ) ;
